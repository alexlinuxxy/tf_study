...
def alexnet_v2(inputs,
  ...
  with variable_scope.variable_scope(scope, 'alexnet_v2', [inputs]) as sc:
    ...
    with arg_scope(
      ...
      if spatial_squeeze:
        net0 = array_ops.squeeze(net0, [1, 2], name='fc8/squeezed')
        end_points[sc.name + '/fc8_0'] = net0
        net1 = array_ops.squeeze(net1, [1, 2], name='fc8/squeezed')
        end_points[sc.name + '/fc8_1'] = net1
        net2 = array_ops.squeeze(net2, [1, 2], name='fc8/squeezed')
        end_points[sc.name + '/fc8_2'] = net2
        net3 = array_ops.squeeze(net3, [1, 2], name='fc8/squeezed')
